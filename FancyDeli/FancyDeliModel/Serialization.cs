...
//         CustomerModel = new List<CustomerInfo>()
//         {
//             Name = 
//             Address = 
//             Email = 
...
//         */
//         string jsonString = JsonSerializer.Serialize(customerobj, new JsonSerializerOptions(){WriteIndented = true});
...
//             Customer customerobj2 = JsonSerializer.Deserialize<Customer>(jsonString2);
//             Console.WriteLine(customerobj2.Name);
...
//             string jsonString3 = JsonSerializer.Serialize(customerobj3);
