...
public class Collections
{
    ...
    //They have a dinamically changing size
    ...
    //HashSet Collections
    //There is no particular order to the elements; it is not zero-based index (meaning you can't get specific elements)
    ...
    //key need to be unique to able to locate information 
    ...
    public void Collectionmain()
    {
        ...
        //Allow us to set what to store in certain positions
        ...
        //Foreach will interate through all the number of the elements of the array
        ...
        foreach(int element in _numbersArray)
        {
            ...
            //For Loop
            //The first block sets a variable; the second block sets some condition to check if it repeat;
            // and the last on block check if there's some sort of increment/decrement of variable 
            ...
            foreach (int elements in _numbersHash)
            {
                Console.WriteLine(elements);
            }
            
            Console.WriteLine("===Dictionary Demo===");
            _personAge.Add("Issa", 26);
            _personAge.Add("Thiero", 34);
            _personAge.Add("Voisin", 38);

            Console.WriteLine(_personAge["Issa"]);

            Console.WriteLine("===ArrayList Demo===");
            _numbersArrayList.Add("Hello");
            _numbersArrayList.Add(10);
            _numbersArrayList.Add(10.03);
